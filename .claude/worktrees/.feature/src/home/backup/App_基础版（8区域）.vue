<!--
  ...
  修改内容：1. 实现页面响应式布局优化，适配手机、平板、桌面设备
           ...
           31. 【界面模式重构】取消showAdvancedColumns高级列控制，所有表格始终显示完整列信息
           32. 【布局优化】重新设计界面模式：正常模式(数据看板+完整表格)，隐藏模式(数据看板+7区域)
           33. 简化Ctrl+M快捷键功能，专注于控制面板切换，移除表格列显示/隐藏控制
           34. 【雪橇算法优化】新增weight=2最高优先级规则：当weight字段等于2时，雪橇数量固定为1，不受factor和数据值影响
-->
<template>
      ...
      <el-main class="data-display">
        <el-card class="data-card" shadow="hover">
          ...
          <div v-if="showControlPanel" class="normal-mode-table-container">
            ...
            <!-- 高级列 - 始终显示 -->
              <el-table-column prop="tag" label="数据点位标签" align="center" min-width="300" show-overflow-tooltip />
            
              <el-table-column prop="quality" label="数据质量" width="80" align="center">
              <template #default="scope">
                <el-tag 
                  size="small" 
              ...
              <el-table-column prop="updateCount" label="更新次数" width="80" align="center">
              <template #default="scope">
              ...
              <el-table-column prop="sequence" label="位置序号" width="100" align="center">
              <template #default="scope">
                <el-tag 
                  size="small" 
                  type="info" 
