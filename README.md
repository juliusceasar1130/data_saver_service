...
- `docs/`: 包含架构设计、数据库元数据中文注释脚本（`03_analytics_db_comments.sql`）、大模型关联防错去重指南（`04_analytics_db_fanout_prevention_guide.md`）、项目车集成规格书（`project_car/project_vehicle_integration_spec.md`）、配置说明与数据迁移方案。
